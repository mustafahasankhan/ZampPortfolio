...
# Demo
To view a live demo, **[click here](https://mustafahasankhan.com/)**
...
- Remove `<meta http-equiv="refresh" content="0;url=https://mustafahasankhan.com/" />` in the `index.html` file
...
- Open up cmd/powershell in admin mode and enter the following line to download this repository
  ...
  - ```python
     git clone https://github.com/mustafahasankhan/ZampPortfolio.git
    ```
